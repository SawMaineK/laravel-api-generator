...
<div class="row">
    ...
    <div class="col-xs-6 col-sm-2 col-lg-2"> 
        <div class="form-group{{ $errors->has('scaffold') ? ' has-error' : '' }}">
            <div class="checkbox">
                <label>{!! Form::checkbox('scaffold', 1, true) !!}<span>Scaffold</span></label>
            </div>
            @if ($errors->has('scaffold'))
                <span class="help-block">
                    <strong>{{ $errors->first('scaffold') }}</strong>
                </span>
            @endif
        </div>
    </div>
    ...
    <div class="col-xs-6 col-sm-2 col-lg-2"> 
        <div class="form-group{{ $errors->has('has_api') ? ' has-error' : '' }}">
            <div class="checkbox">
                <label>{!! Form::checkbox('has_api', 1, false) !!}<span>API</span></label>
            </div>
