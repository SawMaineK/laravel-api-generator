...
<head>
    ...
    <script src="{{ asset('admin/javascripts/application.js') }}" type="text/javascript"></script>
...
<body class="fourofour bg-danger">
    ...
    <div class="fourofour-container">
        ...
        <a class="btn btn-lg btn-default-outline" href="/"><i class="fa fa-home"></i>Return to the homepage</a>
    </div>
    <!-- End Login Screen -->
</body>
